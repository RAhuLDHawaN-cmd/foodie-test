...
router.get("https://foodie-backend.onrender.com/getallpizzas", async(req, res) => {
...
router.post("https://foodie-backend.onrender.com/addpizza", async(req, res) => {
...
router.post("https://foodie-backend.onrender.com/getpizzabyid", async(req, res) => {
